...
% The integrating function for simulations with treatment and drugs enabled
%--------------------------------------------------------------------------
%--------------------------------------------------------------------------
...
% Normalized to A_0
%(18) A (free drug): 
dxdt(18) = - alpha_plus_tilde*PD1_0*x(18)*x(14) + alpha_minus_tilde*x(19)...
           - delta_A_tilde*x(18);
            
% Normalized to A_0
%(19) A:PD-1: 
dxdt(19) = alpha_plus_tilde*PD1_0*x(18)*x(14) - alpha_minus_tilde*x(19);
